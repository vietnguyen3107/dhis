        ...
        return (
            ...
            <div className="row">
                ...
                <div className="col-md-4">
                    ...
                    <input className="form-control" value={this.state.hospitalCode}  />

                </div>

                <div className="col-md-4">
                <label>appCode</label>
                    <input className="form-control" value={this.state.appCode }  />
                </div>
            ...
            <div className="row">
                ...
                <div className="col-md-4">
                    ...
                    <input className="form-control" value={this.state.recipientName}/>
                
                </div>
                <div className="col-md-4">
                    <label>Chức Vụ</label>
                    <input className="form-control" value={this.state.recipientPosition}/>
                </div>
                <div className="col-md-4">
                    <label>Nơi nộp</label>
                    <input className="form-control" value={this.state.lblIssuedPlace}/>
                </div>
            </div>
            ...
            <div className="row">
                ...
                <div className="col-md-4">
                    ...
                    <input className="form-control" value={this.state.processedBy}/>
                </div>
                <div className="col-md-4">
                    <label></label>
                </div>
            ...
            <div className="row">
                ...
                <div className="col-md-4">
                    ...
                    <DatePicker className="form-control"
                    dateFormat= "DD/MM/YYYY"
                        selected={this.state.birthday !="" ? moment(this.state.birthday, "DD/MM/YYYY") : null}
            ...
            <div className="row">
                ...
                <div className="col-md-4">
                    ...
                    <input className="form-control" value={this.state.birthPlaceText}/>
                ...
                <div className="col-md-4">
                    <label>Dân tộc</label>
                    <input className="form-control" value={this.state.ethnicText}/>
            ...
            <div className="row">
                <div className="col-md-4">
                    ...
                    <input className="form-control" value={this.state.peopleIdentity}/>
                
                </div>
                <div className="col-md-4">
                    <label>idIssuedDate</label>
                    <DatePicker className="form-control"
                        selected={this.state.ethnicText}
                    ></DatePicker>
                ...
                <div className="col-md-4">
                    ...
                    <input className="form-control" value={this.state.idIssuedPlaceText}/>
            ...
            <div className="row">
                ...
                <div className="col-md-4">
                    ...
                    <input className="form-control" value={this.state.tempAddress}/>
                
                </div>
                <div className="col-md-4">
                    <label>tempProvince</label>
                    <input className="form-control" value={this.state.tempProvince}/>
                
                </div>
                <div className="col-md-4">
                    <label>tempDistrict</label>
                    <input className="form-control" value={this.state.tempDistrict}/>
            ...
            <div className="row">
                <div className="col-md-4">
                    ...
                    <input className="form-control" value={this.state.tempWard}/>
                ...
                <div className="col-md-4">
                    ...
                    <input className="form-control" value={this.state.mobilePhone}/>
                </div>
            </div>
